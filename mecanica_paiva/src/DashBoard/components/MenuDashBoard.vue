<template>
    <section class="container-fluid menu">
        <ul>
            ...
            <router-link to="/Estatisticas"><li><font-awesome-icon icon="fa-solid fa-chart-line" />&nbsp;&nbsp;&nbsp;Estatísticas</li></router-link>
            <router-link to="/Gerenciar"><li><font-awesome-icon icon="fa-solid fa-house" />  &nbsp;&nbsp;&nbsp;Gerenciar</li></router-link>
